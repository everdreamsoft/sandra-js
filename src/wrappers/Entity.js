...
class Entity {
    ...
    asJSON() {
        ...
        this.triplets.forEach((t, i) => {
            ...
            let verb = ((_a = t.getVerb()) === null || _a === void 0 ? void 0 : _a.getShortname()) ? (_b = t.getVerb()) === null || _b === void 0 ? void 0 : _b.getShortname() : (_c = t.getVerb()) === null || _c === void 0 ? void 0 : _c.getId();
            let sn = (_d = t.getTarget()) === null || _d === void 0 ? void 0 : _d.getShortname();
            if (sn && sn.length > 0) {
                if (verb) {
                    json["brothers"][verb] = sn;
                    if (verb != "contained_in_file") {
                        let rfs = (_e = this.references) === null || _e === void 0 ? void 0 : _e.filter(r => { var _a; return ((_a = r.getTripletLink()) === null || _a === void 0 ? void 0 : _a.getId()) == t.getId(); });
                ...
                if (verb) {
                    ...
                    if (t.getJoinedEntity()) {
                        j[verb] = (_f = t.getJoinedEntity()) === null || _f === void 0 ? void 0 : _f.asJSON();
                    }
                    else {
                    ...
                    json["joined"].push(j);
                    if (t.getVerbEntity()) {
                        j[verb]["verb_entity"] = (_j = t.getVerbEntity()) === null || _j === void 0 ? void 0 : _j.asJSON();
                    }
                }
            }
        });
