...
var SystemConcepts = /** @class */ (function () {
    function SystemConcepts() {
    }
    SystemConcepts.add = function (concept) {
        if (concept.getShortname()) {
            // Check if it exist
            var i = SystemConcepts.concepts.findIndex(function (c) { return concept.isSame(concept); });
            if (i >= 0)
                return SystemConcepts.concepts[i];
        }
        throw new Error("Not a system concpet, trying to push shortname with null value");
    };
    SystemConcepts.load = function (shortname) {
        return __awaiter(this, void 0, void 0, function () {
            var c;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DBAdapter_1.DBAdapter.getInstance()];
                    case 1: return [4 /*yield*/, (_a.sent()).getConcept(shortname)];
                    case 2:
                        c = _a.sent();
    ...
    SystemConcepts.get = function (shortname) {
        return __awaiter(this, void 0, void 0, function () {
            var c;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        c = SystemConcepts.concepts.find(function (concept) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, DBAdapter_1.DBAdapter.getInstance()];
                    case 3: return [4 /*yield*/, (_a.sent()).addConcept(new Concept_1.Concept(-1, Concept_1.Concept.SYSTEM_CONCEPT_CODE_PREFIX + shortname, shortname))];
                    case 4:
